...
lower_leg.export("../assets/quad_parts/lower_leg_v1.svg")
lower_leg.export("../assets/quad_parts/lower_leg_v1.step")
lower_leg.export("../assets/quad_parts/lower_leg_v1.stl")
