...
motor_up = motor.translate((0, 0, leg_B/2)).rotate((0,0,0),(0,0,1),90)
motor_knee = motor.rotate((0,0,0),(0,0,1),90).rotate((0,0,0),(0,0,1),(180 + degrees(bend_angle) + 3)).translate((c5[0],c5[1], leg_B/2))

# show_object(motor_up)
# show_object(motor_knee)
