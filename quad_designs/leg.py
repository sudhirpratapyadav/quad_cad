...
# sketch = sketch.segment(p1,p2)
# sketch = sketch.segment(p2,p3)
# sketch = sketch.segment(p3,p4)
sketch = sketch.arc(p0,r0,90+th1*180/math.pi,180)
# sketch = sketch.arc(p1,r1,0,360)
# sketch = sketch.arc(p1_actual,r1_actual,0,360)
sketch = sketch.arc(p2,r2,0,360)
# sketch = sketch.arc(p3,r3,0,360)
sketch = sketch.arc(p4,r4,0,360)

# sketch = sketch.segment(c1a,c2a)
# sketch = sketch.segment(c1b,c2b)
# sketch = sketch.segment(c3a,c4a)
# sketch = sketch.segment(c3b,c4b)
# sketch = sketch.segment(c5a,c6a)
sketch = sketch.segment(c5b,c6b)
# sketch = sketch.segment(c7a,c8a)
sketch = sketch.segment(c6b,c7b)
sketch = sketch.segment(c7b,c8b)
# sketch = sketch.segment(c1a, c2a_actual)
...
# sketch = sketch.spline([c5a, c7a, c8a], [t2,t2,t3], False)
# sketch = sketch.spline([c5b, c7b, c8b], [t2,t2,t3], False)

sketch = sketch.spline([c5a, c7a, c8a], [t2,t3,t4], False)
# sketch = sketch.spline([c5b, c7b, c8b], [t2,t3,t4], False)
