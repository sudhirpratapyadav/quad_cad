...
upper_leg.export("../assets/quad_parts/leg_upper_v1.svg")
upper_leg.export("../assets/quad_parts/leg_upper_v1.step")
upper_leg.export("../assets/quad_parts/leg_upper_v1.stl")
print("Upper leg v1 saved successfully!")