...
motor_socket = motor_socket.union(motor)
...
body.export("../assets/quad_parts/body_with_motor_v1.svg")
body.export("../assets/quad_parts/body_with_motor_v1.step")
body.export("../assets/quad_parts/body_with_motor_v1.stl")
print("body with motor v1 saved successfully!")